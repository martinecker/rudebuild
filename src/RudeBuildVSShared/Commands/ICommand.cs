...
namespace RudeBuildVSShared
{
    public interface ICommand
    {
        ...
        void Initialize(string name, string caption, string toolTip, EnvDTE.Command vsCommand);
    ...
    public abstract class CommandBase : ICommand
    {
        ...
        public void Initialize(string name, string caption, string toolTip, EnvDTE.Command vsCommand)
        {
            Name = name;
            Caption = caption;
            ToolTip = toolTip;
