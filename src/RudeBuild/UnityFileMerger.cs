...
namespace RudeBuild
{
    ...
    public sealed class UnityFileMerger
    {
        ...
        private void WritePrologue(ProjectInfo projectInfo, StringBuilder text)
        {
        ...
        private void WriteEpilogue(StringBuilder text)
        {
            text.AppendLine();
        ...
        public void Process(ProjectInfo projectInfo)
        {
            ...
            foreach (string cppFileName in cppFileNames)
            {
                ...
                if (!_unityFiles.TryGetValue(fileExtension, out unityFile))
                {
                    ...
                    WritePrologue(projectInfo, unityFile.Contents);
                }
