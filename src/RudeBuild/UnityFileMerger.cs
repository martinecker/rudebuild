...
namespace RudeBuild
{
    ...
    public class UnityFileMerger
    {
        ...
        private void WritePrefix(ProjectInfo projectInfo, StringBuilder text)
        {
            ...
            text.AppendLine();
            if (!string.IsNullOrEmpty(GetFullPrecompiledHeaderPath(projectInfo)))
            {
        ...
        private string GetFullPrecompiledHeaderPath(ProjectInfo projectInfo)
        {
            ...
            return precompiledHeaderFilePath;
        }
        ...
        private void WriteEmptyPrecompiledHeader(ProjectInfo projectInfo)
        {
            ...
            string precompiledHeaderFilePath = GetFullPrecompiledHeaderPath(projectInfo);
            if (string.IsNullOrEmpty(precompiledHeaderFilePath))
                return;
